...
contains
  ...
  !! @author Iredell @date 96-04-10
    ...
    subroutine gdswzd_polar_stereo(self,iopt,npts, &
        ...
        ! - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    endsubroutine gdswzd_polar_stereo
    ...
    endsubroutine polar_stereo_vect_rot
    ...
    endsubroutine polar_stereo_map_jacob
    ...
    endsubroutine polar_stereo_grid_area

endmodule ip_polar_stereo_grid_mod
