!> @file
!! GDS WIZARD MODULE FOR MERCATOR CYLINDRICAL GRIDS
!!
...
!!
!! DRIVER ROUTINE THAT DECODES THE GRIB GRID DESCRIPTION SECTION
!! (PASSED IN INTEGER FORM AS DECODED BY SUBPROGRAM W3FI63) AND RETURNS
!! ONE OF THE FOLLOWING: (IOPT=+1) EARTH COORDINATES OF SELECTED GRID
!! COORDINATES (IOPT=-1) GRID COORDINATES OF SELECTED EARTH COORDINATES
!! FOR MERCATOR CYLINDRICAL PROJECTIONS.  IF THE SELECTED COORDINATES
!! ARE MORE THAN ONE GRIDPOINT BEYOND THE THE EDGES OF THE GRID DOMAIN,
!! THEN THE RELEVANT OUTPUT ELEMENTS ARE SET TO FILL VALUES.  THE
!! ACTUAL NUMBER OF VALID POINTS COMPUTED IS RETURNED TOO.  OPTIONALLY,
!! THE VECTOR ROTATIONS, MAP JACOBIANS AND THE GRID BOX AREAS MAY BE
!! RETURNED AS WELL.  TO COMPUTE THE VECTOR ROTATIONS, THE OPTIONAL
!! ARGUMENTS 'SROT' AND 'CROT' MUST BE PRESENT.  TO COMPUTE THE MAP
!! JACOBIANS, THE OPTIONAL ARGUMENTS 'XLON', 'XLAT', 'YLON', 'YLAT'
!! MUST BE PRESENT.  TO COMPUTE THE GRID BOX AREAS, THE OPTIONAL
...
!!
!! @param RLAT     - LATITUDE IN DEGREES (REAL)
...
!! A MERCATOR CYLINDRICAL GRID.
!!
!! @param RLAT     - LATITUDE OF GRID POINT IN DEGREES (REAL)
