...
!
!> THIS SUBPROGRAM PROVIDES THE ROTATION PARAMETERS
...
!!
!! @param FLAT     - REAL LATITUDE IN DEGREES FROM WHICH TO MOVE THE VECTOR
!! @param FLON     - REAL LONGITUDE IN DEGREES FROM WHICH TO MOVE THE VECTOR
!! @param TLAT     - REAL LATITUDE IN DEGREES TO WHICH TO MOVE THE VECTOR
!! @param TLON     - REAL LONGITUDE IN DEGREES TO WHICH TO MOVE THE VECTOR
