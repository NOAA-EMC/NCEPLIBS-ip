...
!
! USAGE:    CALL GDSWZD01(IGDTNUM,IGDTMPL,IGDTLEN,IOPT,NPTS,FILL, &
!                         XPTS,YPTS,RLON,RLAT,NRET, &
!                         CROT,SROT,XLON,XLAT,YLON,YLAT,AREA)
!
!   INPUT ARGUMENT LIST:
...
!$$$  SUBPROGRAM DOCUMENTATION BLOCK
!
! SUBPROGRAM:  GDSWZD01_ERROR   GDSWZD01 ERROR HANDLER
...
!
! USAGE:    CALL GDSWZD01_ERROR(IOPT,FILL,RLAT,RLON,XPTS,YPTS,NPTS)
!
!   INPUT ARGUMENT LIST:
!     IOPT     - INTEGER OPTION FLAG
!                (+1 TO COMPUTE EARTH COORDS OF SELECTED GRID COORDS)
