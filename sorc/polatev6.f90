 SUBROUTINE POLATEV6(IPOPT,GDTNUMI,GDTMPLI,GDTLENI, &
...
!
! USAGE:    CALL POLATEV6(IPOPT,GDTNUMI,GDTMPLI,GDTLENI, &
!                         GDTNUMO,GDTMPLO,GDTLENO, &
!                         MI,MO,KM,IBI,LI,UI,VI, &
!                         NO,RLAT,RLON,CROT,SROT,IBO,LO,UO,VO,IRET)
!
...
!  COMPUTE NUMBER OF OUTPUT POINTS AND THEIR LATITUDES AND LONGITUDES.
 ...
 ELSE
   IRET=31
 ENDIF
 CALL CHECK_GRIDS6V(GDTNUMI,GDTMPLI,GDTLENI,SAME_GRID)
...
!
 SUBROUTINE CHECK_GRIDS6V(GDTNUM,GDTMPL,GDTLEN,SAME_GRID)
!$$$  SUBPROGRAM DOCUMENTATION BLOCK
!
...
!
! USAGE:  CALL CHECK_GRIDS6V(GDTNUM,GDTMPL,GDTLEN,SAME_GRID)
!
!   INPUT ARGUMENT LIST:
