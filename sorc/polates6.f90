...
!
 REAL,       ALLOCATABLE       :: CROT(:),SROT(:),DUM1(:),DUM2(:)
 REAL,       ALLOCATABLE       :: DUM3(:),DUM4(:),DUM5(:)
...
!  COMPUTE NUMBER OF OUTPUT POINTS AND THEIR LATITUDES AND LONGITUDES.
 ...
 IF(IGDTNUMO.GE.0) THEN
   ...
   DEALLOCATE(CROT,SROT,DUM1,DUM2,DUM3,DUM4,DUM5)
   IF(NO.EQ.0) IRET=3
 ELSE
   IRET=31
 ENDIF
...
!  LOCATE INPUT POINTS AND COMPUTE THEIR WEIGHTS
   ...
   IF(WB.NE.0) THEN
     ...
     ALLOCATE(DUM4(NO))
     ALLOCATE(DUM5(NO))
     CALL GDSWZD(IGDTNUMO,IGDTMPLO,IGDTLENO, 1,NO,FILL,XPTB,YPTB,RLOB,RLAB,&
                 NV,0,CROT,SROT,0,DUM1,DUM2,DUM3,DUM4,DUM5)
     CALL GDSWZD(IGDTNUMI,IGDTMPLI,IGDTLENI,-1,NO,FILL,XPTB,YPTB,RLOB,RLAB,&
                 NV,0,CROT,SROT,0,DUM1,DUM2,DUM3,DUM4,DUM5)
     DEALLOCATE(CROT,SROT,DUM1,DUM2,DUM3,DUM4,DUM5)
