 SUBROUTINE POLATES0(IPOPT,GDTNUMI,GDTMPLI,GDTLENI,  &
                     GDTNUMO,GDTMPLO,GDTLENO,MI,MO,KM,IBI,LI,GI, &
...
!
! USAGE:    CALL POLATES0(IPOPT,GDTNUMI,GDTMPLI,GDTLENI,  &
!                    GDTNUMO,GDTMPLO,GDTLENO,MI,MO,KM,IBI,LI,GI, &
!                    NO,RLAT,RLON,IBO,LO,GO,IRET)
!
!   INPUT ARGUMENT LIST:
...
!
! USAGE:  CALL CHECK_GRIDS0(GDTNUMI,GDTMPLI,GDTLENI,GDTNUMO,GDTMPLO, &
