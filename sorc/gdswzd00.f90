...
!
! USAGE:    CALL GDSWZD00(IGDTNUM,IGDTMPL,IGDTLEN,IOPT,NPTS,FILL, &
!                    XPTS,YPTS,RLON,RLAT,NRET,  &
!                    LROT,CROT,SROT,LMAP,XLON,XLAT,YLON,YLAT,AREA)
! 
!   INPUT ARGUMENT LIST:
...
!$$$  SUBPROGRAM DOCUMENTATION BLOCK
!
! SUBPROGRAM:  GDSWZD00_ERROR   GDSWZD00 ERROR HANDLER
...
!
! USAGE:    CALL GDSWZD00_ERROR(IOPT,FILL,RLAT,RLON,XPTS,YPTS,NPTS)
!
!   INPUT ARGUMENT LIST:
!     IOPT     - INTEGER OPTION FLAG
!                (+1 TO COMPUTE EARTH COORDS OF SELECTED GRID COORDS)
