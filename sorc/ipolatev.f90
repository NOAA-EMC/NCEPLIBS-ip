...
!             (KGDS(1)=203) ROTATED EQUIDISTANT CYLINDRICAL
...
!                NOTE: IF KGDSI(1)=201 OR KGDSI(1)=203,
!                      THEN THE 9TH BIT OF KGDSI(11)
...
!                NOTE: IF KGDSO(1)=201 OR KGDSO(1)=203,
!                      THEN THE 9TH BIT OF KGDSO(11)
!                      IS TEMPORARILY SET TO 1 TO ALERT THE GDS WIZARD
!                      THAT THESE FIELDS ARE STAGGERED ETA WINDS.
