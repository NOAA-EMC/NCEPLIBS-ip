 SUBROUTINE POLATEV0(IPOPT,GDTNUMI,GDTMPLI,GDTLENI, &
...
!           STATION POINTS IF GDTNUMO<0, IN WHICH CASE THE NUMBER
...
!
! USAGE:    CALL POLATEV0(IPOPT,GDTNUMI,GDTMPLI,GDTLENI, &
!                         GDTNUMO,GDTMPLO,GDTLENO, &
!                         MI,MO,KM,IBI,LI,UI,VI, &
!                         NO,RLAT,RLON,CROT,SROT,IBO,LO,UO,VO,IRET)
!
...
!  SET PARAMETERS
 ...
 PMP=MP*0.01
! - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
 CALL CHECK_GRIDS0V(GDTNUMI,GDTMPLI,GDTLENI,GDTNUMO,GDTMPLO,GDTLENO, &
...
! - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
 SUBROUTINE CHECK_GRIDS0V(GDTNUMI,GDTMPLI,GDTLENI,GDTNUMO,GDTMPLO,GDTLENO, &
                          SAME_GRIDI, SAME_GRIDO)
!$$$  SUBPROGRAM DOCUMENTATION BLOCK
!
...
!
! USAGE:  CALL CHECK_GRIDS0V(GDTNUMI,GDTMPLI,GDTLENI,GDTNUMO,GDTMPLO, &
