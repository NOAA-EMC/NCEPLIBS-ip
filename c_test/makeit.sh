...
icc -c -std=c99 -I../ip/v3.0.0/include/ip_v3.0.0_4 test_gdswzd_4.c
...
icc -c -std=c99 -I../ip/v3.0.0/include/ip_v3.0.0_d test_gdswzd_d.c
...
icc -c -std=c99 -I../ip/v3.0.0/include/ip_v3.0.0_8 test_gdswzd_8.c
